...
namespace Task_manager_v2
{
    public partial class MainForm : Form
    {
        ...
        private void ListBox_DoubleClick(object sender, EventArgs e)
        {
            ...
            foreach (string line in lines)
            {
                ...
                if (parts[1] == name)
                {
                    ...
                    TaskEdit taskEdit = new TaskEdit(_username, status, name, artist, description, _originalTaskName);
        ...
        private void add_task_Click(object sender, EventArgs e)
        {
            ...
            TaskEdit taskEdit = new TaskEdit(_username, "", "", "", "", "");
        ...
        private void UpdateTaskStatus(string taskName, string status)
        {
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                if (parts[1] == taskName)
                {
                    lines[i] = status + ";" + taskName + ";" + parts[2] + ";" + parts[3] + ";";
                    break;
                }
            }
